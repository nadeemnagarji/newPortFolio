...
export default function About(params) {
    ...
    return(
        <div ref={ref}  data-scroll  data-scroll-section data-scroll-speed="-0.1"  className=" w-full z-20 py-20 bg-[#FAFAF9] rounded-tl-3xl  rounded-tr-3xl  px-10 max-laptop:px-5 "> 
                ...
                className=" text-center  uppercase  text-[#8c8c73] font-main font-bold tracking-tight text-[10vw]">
                about  me 
                </motion.h1>
                ...
                <div className="mt-10 flex w-full border-t-[1px] border-[#a1b562] max-tablet:flex-col max-tablet:items-center max-tablet:gap-10">
                    <div className=" w-1/2 mt-5 max-tablet:w-full ">
                    ...
                    <div ref={ref}  className="w-2/3 mt-5 font-main tracking-wider  rounded-3xl h-fit p-5 bg-[#004D43]  text-4xl flex   justify-around items-start max-tablet:w-full">
                        <motion.div 
